...
namespace IndieGabo.HandyFSM.CCPro
{
    ...
    public class NormalMovementState : ScriptableCCProState
    {
        ...
        protected virtual void OnPreCharacterSimulation(float dt)
        {
            ...
            Animator.SetBool(MovementStats.GroundedAnimationParameter, CharacterActor.IsGrounded);
            Animator.SetBool(MovementStats.StableAnimationParameter, CharacterActor.IsStable);
            Animator.SetFloat(MovementStats.HorizontalAxisAnimationParameter, CharacterActions.movement.value.x);
            Animator.SetFloat(MovementStats.VerticalAxisAnimationParameter, CharacterActions.movement.value.y);
            Animator.SetFloat(MovementStats.HeightAnimationParameter, CharacterActor.BodySize.y);
        }
        ...
        public virtual void OnPostCharacterSimulation(float dt)
        {
            ...
            Animator.SetFloat(MovementStats.VerticalSpeedAnimationParameter, CharacterActor.LocalVelocity.y);
            Animator.SetFloat(MovementStats.PlanarSpeedAnimationParameter, CharacterActor.PlanarVelocity.magnitude);
        }
        ...
        protected virtual void ProcessPlanarMovement(float dt)
        {
            ...
            bool needToAccelerate = CustomUtilities.Multiply(InputMovementReference, _currentPlanarSpeedLimit).sqrMagnitude >= CharacterActor.PlanarVelocity.sqrMagnitude;
            ...
            switch (CharacterActor.CurrentState)
            {
                case CharacterActorState.NotGrounded:
                    ...
                    targetPlanarVelocity = CustomUtilities.Multiply(InputMovementReference, speedMultiplier, _currentPlanarSpeedLimit);
